...
BOOST_PYTHON_MODULE(AdaptSizeSim) {
  ...
  class_<AdaptSizeSimulator>("AdaptSizeSimulator", init<uint64_t>())
      ...
      .def("toJSON", &AdaptSizeSimulator::toString)
      ...
      .def_readonly("prediction_updated_eviction",
                    &AdaptSizeSimulator::prediction_updated_eviction)
      .def_readonly("prediction_updated_admission",
                    &AdaptSizeSimulator::prediction_updated_admission);
}
