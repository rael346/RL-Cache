...
parser.add_argument(
    "-e", "--preload_eviction", action="store_true", help="Load pretrained eviction"
)
parser.add_argument(
    "-a", "--preload_admission", action="store_true", help="Load pretrained admission"
)
...
train(
    configuration,
    args.preload_admission,
    args.preload_eviction,
